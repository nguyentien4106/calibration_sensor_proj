...
public partial class HomePageViewModel : BaseViewModel
{
    ...
    public IAsyncRelayCommand ConnectDeviceAsyncCommand { get; }
    ...
    public HomePageViewModel(BluetoothLEService bluetoothLEService)
    {
        ...
        ConnectDeviceAsyncCommand = new AsyncRelayCommand<DeviceCandidate>(async (device) => await ConnectDeviceAsync(device));
    }
    ...
    async Task ConnectDeviceAsync(DeviceCandidate device)
    {
